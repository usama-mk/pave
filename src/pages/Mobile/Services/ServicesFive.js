...
import dm_main from '../../../assets/images/digital-marketing/mobile/tm_main_img.png'
...
function ServicesFive() {
  ...
  return (
    ...
    <ServiceHeader title={`Talent Marketing`} />
    ...
    <div className='flex items-center ml-8 mb-5' >     
        ...
        <h5 className='text-[15px] text-white' >Talent, Artist & DJ Bookings</h5>
        <h5 className='text-[15px] text-white' >Celebrity & VIP Relations</h5>
        <h5 className='text-[15px] text-white' >Mega & Giga Influencer Relations</h5>
        <h5 className='text-[15px] text-white' >Private, Live & Corporate Events</h5>
        <h5 className='text-[15px] text-white' >Charity & Non Profit Activations</h5>
        <h5 className='text-[15px] text-white' >Virtual Entertainment</h5>
        <h5 className='text-[15px] text-white' >Production & Creatives</h5>
        <h5 className='text-[15px] text-white' >Talent Branding</h5>
        <h5 className='text-[15px] text-white' >Partnership Development</h5>
