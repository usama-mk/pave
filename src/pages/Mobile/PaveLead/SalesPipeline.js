  ...
  return (
    ...
    >
      ...
      <div className="mb-[100px] px-[6%] ">
        ...
        <div className="ml-12">
          <h5 className="text-[12px] font-semibold leading-[18px] text-left mt-10  ">
            Target the right prospects. Align marketing action with your ideal
            buyer's needs. Too many marketers focus on metrics that have little
            significance to business growth. Ironpaper focuses on outcomes,
            specifically creating and engaging qualified leads. To do this, our
            work crosses boundaries.
          </h5>
          <SalesPipelineComp
            img={splOne}
            title={"Insight into deals"}
            subTitle={`A sales pipeline provides the much-needed insights
...
likely to close.`}
          ...
          <SalesPipelineComp
            ...
            subTitle={`A sales pipeline gives you visibility into the performance of
...
are to meeting sales targets`}
          ...
          <SalesPipelineComp
            ...
            subTitle={`A sales pipeline is also an indicator of the value of deals that 
