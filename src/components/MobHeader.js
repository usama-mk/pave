...
function MobHeader({purpleTheme, redTheme, buttonTitle, yellowTheme}) {
  ...
  return (
    <div onClick={()=>  dispatch(openLeadPopUp())} style={{backgroundColor: purpleTheme?`#410D7F`:redTheme?'#FD4C3C':yellowTheme?'#FEB52B':'', opacity:purpleTheme?1:'', opacity: redTheme?'100%':'', opacity: yellowTheme?1:'' }} className="topHeader pt-[20px] pb-[10px] pl-[6%] pr-[6%] flex justify-between w-[100%] bg-[#EFEFEF] opacity-80 h-fit">
