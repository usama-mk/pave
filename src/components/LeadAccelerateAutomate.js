...
function LeadAccelerateAutomate({tabOne, tabTwo, tabThree, tabFour, selected }) {
  return (
    <div className='grid grid-flow-col gap-8 overflow-x-scroll  ' >
        ...
        <h5 style={{borderColor:selected==='one'?'black':'#CBCBCB'}} className='text-[12px] leqading-[14px] ' >{tabOne}</h5>
        ...
        <div className='w-[160px] '>
        <h5 style={{borderColor:selected==='two'?'black':'#CBCBCB'}} className='text-[12px] leqading-[14px] ' >{tabTwo}</h5>
        ...
        <div className='w-[160px] '>
        <h5 style={{borderColor:selected==='three'?'black':'#CBCBCB'}} className='text-[12px] leqading-[14px] ' >{tabThree}</h5>
        ...
        <div className='w-[160px] '>
        <h5 style={{borderColor:selected==='four'?'black':'#CBCBCB'}} className='text-[12px] leqading-[14px] ' >{tabFour}</h5>
